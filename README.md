...
**Примечание**
Для корректной работы программы необходимо в syntax.txt и в CFGsyntax.txt писать параметры словами без лишних символов. (Например, [Concat] записывается как Concat), далее указывается = без пробелов, затем ставится пробел и указывается значение. Пример правильного написания можно посмотреть ниже.
